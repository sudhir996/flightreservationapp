...
public class PdfGenerator {
    ...
    public  void writeUsingIText(String filePath, String name, String emailId, String phone, String operatingAirlines, Date departureDate, String departureCity, String arrivalCity) {
        try {
